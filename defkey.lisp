...
(define-key *top-map* (kbd "XF86Calculator") '*root-map*)
...
(define-key *tile-group-top-map* (kbd "XF86Calculator") '*tile-group-root-map*)
...
(define-key *root-map* (kbd "C-F11") "tag-fake-fullscreen")
